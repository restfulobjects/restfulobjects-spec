...
== 3.1Domain Metadata (x-ro-domain-model)
...
• a value of "none" indicates that the implementation does not provide domain type information; • a value of "simple" or "formal" means that the server supports only that scheme • a value of "selectable" is for implementations that support both schemes.
...
== 3.2Validation (x-ro-validate-only)
...
== 3.3Blobs/Clobs and Attachments
