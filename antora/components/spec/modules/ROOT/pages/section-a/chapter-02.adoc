...
This will be accompanied by an *Allow* header to indicate which methods are allowed by the resource.
...
The optional parameters are modelled after the optional parameters of media types (§2.4.1, §2.4.2).
