...
This style of REST is supported by Restful Objects in that all resources in Restful Objects are discoverable from the Home Page resource xref:section-a/chapter-04.adoc[§B4], acting as a well-known starting point.
